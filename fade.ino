...
void fade(int r1, int g1, int b1, int r2, int g2, int b2, int t)
{
  ...
  for ( float i=0; i<=t; i++ )
  {
    ...
    //output
    analogWrite(rpin1, (int)output_r);
    analogWrite(gpin1, (int)output_g);
    analogWrite(bpin1, (int)output_b);
    analogWrite(rpin2, (int)output_r);
    analogWrite(gpin2, (int)output_g);
    analogWrite(bpin2, (int)output_b);
